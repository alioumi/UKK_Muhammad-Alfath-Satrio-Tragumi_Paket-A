                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{ route('laporma.login') }}" method="POST">
                                        ...
                                        <button type="submit" class="btn bg-info btn-user text-white btn-block">LOGIN</button>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="{{ route('laporma.formRegister') }}">Belum Mempunyai Akun? <i>register</i> sekarang!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
